...
export const api = {
  ...
  forecastXgb: (data: ForecastRequest) => fetchApi<ForecastResponse>("/forecast/xgb", { method: "POST", body: JSON.stringify(data) }),
  forecastChronos: (data: ForecastRequest) => fetchApi<ForecastResponse>("/forecast/chronos", { method: "POST", body: JSON.stringify(data) }),
